  ...
  (
    ...
    def lex_token__ATOM(input0) do
      with {:ok, t0, rest0} <- lex_expr__6(input0),
           ...
           {:ok, t2, rest2} <- lex_expr__10(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_token__TRIVIA(input) do
      Tokenizer.star_char(&lex_expr__14/1, input)
    end
    ...
    def lex_expr__17(input) do
      Tokenizer.plus_char(&lex_expr__18/1, input)
    end
    ...
    def lex_expr__23(input) do
      Tokenizer.star_char(&lex_expr__24/1, input)
    end
    ...
    def lex_token__NOT_EQ(input0) do
      with {:ok, t0, rest0} <- lex_expr__28(input0),
           {:ok, t1, rest1} <- lex_expr__29(rest0),
           {:ok, t2, rest2} <- lex_expr__30(rest1),
           {:ok, t3, rest3} <- lex_expr__31(rest2) do
    ...
    def lex_token__INTEGER(input) do
      Tokenizer.plus_char(&lex_expr__32/1, input)
    end
    ...
    def lex_expr__40(input0) do
      with {:ok, t0, rest0} <- lex_expr__41(input0),
           ...
           {:ok, t2, rest2} <- lex_expr__43(rest1),
           {:ok, t3, rest3} <- lex_expr__44(rest2),
           {:ok, t4, rest4} <- lex_expr__45(rest3) do
    ...
    def lex_token__ESCAPE(input0) do
      with {:ok, t0, rest0} <- lex_expr__33(input0), {:ok, t1, rest1} <- lex_expr__34(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__53(input) do
      Tokenizer.first_char_match([&lex_expr__54/1, &lex_expr__55/1], input)
    end

    def lex_expr__52(input) do
      Tokenizer.star_char(&lex_expr__53/1, input)
    end

    def lex_token__IDENT(input0) do
      with {:ok, t0, rest0} <- lex_expr__49(input0), {:ok, t1, rest1} <- lex_expr__52(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_token__KW_DEEP(input0) do
      with {:ok, t0, rest0} <- lex_expr__56(input0),
           ...
           {:ok, t3, rest3} <- lex_expr__59(rest2) do
        {:ok, t0 <> t1 <> t2 <> t3, rest3}
      else
        :fail -> :fail
      end
    ...
    def lex_token__LE(input0) do
      with {:ok, t0, rest0} <- lex_expr__60(input0), {:ok, t1, rest1} <- lex_expr__61(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__70(input) do
      Tokenizer.not_pred_char(&lex_expr__71/1, input)
    end
    ...
    def lex_expr__69(input0) do
      with {:ok, t0, rest0} <- lex_expr__70(input0), {:ok, t1, rest1} <- lex_expr__75(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_token__KW_SIBLINGS(input0) do
      with {:ok, t0, rest0} <- lex_expr__95(input0),
           ...
           {:ok, t3, rest3} <- lex_expr__98(rest2),
           {:ok, t4, rest4} <- lex_expr__99(rest3),
           {:ok, t5, rest5} <- lex_expr__100(rest4),
           {:ok, t6, rest6} <- lex_expr__101(rest5),
           {:ok, t7, rest7} <- lex_expr__102(rest6) do
    ...
    def lex_expr__104(input) do
      Tokenizer.first_char_match([&lex_expr__105/1, &lex_expr__106/1], input)
    end
    ...
    def lex_expr__108(input) do
      Tokenizer.first_char_match([&lex_expr__109/1, &lex_expr__110/1], input)
    end

    def lex_expr__107(input) do
      Tokenizer.star_char(&lex_expr__108/1, input)
    end
    ...
    def lex_token__POW(input0) do
      with {:ok, t0, rest0} <- lex_expr__111(input0), {:ok, t1, rest1} <- lex_expr__112(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_token__RADIX(input) do
      Tokenizer.first_char_match([&lex_expr__113/1, &lex_expr__118/1, &lex_expr__123/1], input)
    end
    ...
    def lex_token__KW_ANCESTORS(input0) do
      with {:ok, t0, rest0} <- lex_expr__128(input0),
           ...
           {:ok, t3, rest3} <- lex_expr__131(rest2),
           {:ok, t4, rest4} <- lex_expr__132(rest3),
           {:ok, t5, rest5} <- lex_expr__133(rest4),
           {:ok, t6, rest6} <- lex_expr__134(rest5),
           {:ok, t7, rest7} <- lex_expr__135(rest6),
           {:ok, t8, rest8} <- lex_expr__136(rest7) do
    ...
    def lex_expr__142(input) do
      Tokenizer.plus_char(&lex_expr__143/1, input)
    end
    ...
    def lex_expr__139(input) do
      Tokenizer.opt_char(&lex_expr__140/1, input)
    end
    ...
    def lex_expr__164(input) do
      Tokenizer.not_pred_char(&lex_expr__165/1, input)
    end
    ...
    def lex_expr__163(input0) do
      with {:ok, t0, rest0} <- lex_expr__164(input0), {:ok, t1, rest1} <- lex_expr__166(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__160(input) do
      Tokenizer.star_char(&lex_expr__161/1, input)
    end
    ...
    def lex_expr__174(input) do
      Tokenizer.not_pred_char(&lex_expr__175/1, input)
    end
    ...
    def lex_expr__173(input0) do
      with {:ok, t0, rest0} <- lex_expr__174(input0), {:ok, t1, rest1} <- lex_expr__176(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__171(input) do
      Tokenizer.first_char_match([&lex_expr__172/1, &lex_expr__173/1], input)
    end

    def lex_expr__170(input) do
      Tokenizer.star_char(&lex_expr__171/1, input)
    end
    ...
    def lex_expr__168(input0) do
      with {:ok, t0, rest0} <- lex_expr__169(input0),
           ...
           {:ok, t2, rest2} <- lex_expr__177(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_token__STRING(input) do
      Tokenizer.first_char_match([&lex_expr__158/1, &lex_expr__168/1], input)
    end
    ...
    def lex_token__GE(input0) do
      with {:ok, t0, rest0} <- lex_expr__178(input0), {:ok, t1, rest1} <- lex_expr__179(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__181(input) do
      Tokenizer.first_char_match([&lex_expr__182/1, &lex_expr__183/1], input)
    end
    ...
    def lex_expr__211(input0) do
      with {:ok, t0, rest0} <- lex_expr__212(input0), {:ok, t1, rest1} <- lex_expr__213(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__210(input) do
      Tokenizer.opt_char(&lex_expr__211/1, input)
    end
    ...
    def lex_expr__218(input0) do
      with {:ok, t0, rest0} <- lex_expr__219(input0),
           {:ok, t1, rest1} <- lex_expr__220(rest0),
           {:ok, t2, rest2} <- lex_expr__221(rest1),
           {:ok, t3, rest3} <- lex_expr__222(rest2),
           {:ok, t4, rest4} <- lex_expr__223(rest3),
           {:ok, t5, rest5} <- lex_expr__224(rest4) do
        {:ok, t0 <> t1 <> t2 <> t3 <> t4 <> t5, rest5}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__216(input) do
      Tokenizer.first_char_match([&lex_expr__217/1, &lex_expr__218/1], input)
    end

    def lex_expr__215(input) do
      Tokenizer.opt_char(&lex_expr__216/1, input)
    end

    def lex_expr__200(input0) do
      with {:ok, t0, rest0} <- lex_expr__201(input0),
           {:ok, t1, rest1} <- lex_expr__202(rest0),
           {:ok, t2, rest2} <- lex_expr__203(rest1),
           {:ok, t3, rest3} <- lex_expr__204(rest2),
           {:ok, t4, rest4} <- lex_expr__205(rest3),
           {:ok, t5, rest5} <- lex_expr__206(rest4),
           {:ok, t6, rest6} <- lex_expr__207(rest5),
           {:ok, t7, rest7} <- lex_expr__208(rest6),
           {:ok, t8, rest8} <- lex_expr__209(rest7),
           {:ok, t9, rest9} <- lex_expr__210(rest8),
           {:ok, t10, rest10} <- lex_expr__215(rest9) do
    ...
    def lex_expr__199(input) do
      Tokenizer.opt_char(&lex_expr__200/1, input)
    end
    ...
    def lex_token__DATE(input0) do
      with {:ok, t0, rest0} <- lex_expr__189(input0),
           ...
           {:ok, t3, rest3} <- lex_expr__192(rest2),
           {:ok, t4, rest4} <- lex_expr__193(rest3),
           {:ok, t5, rest5} <- lex_expr__194(rest4),
           {:ok, t6, rest6} <- lex_expr__195(rest5),
           {:ok, t7, rest7} <- lex_expr__196(rest6),
           {:ok, t8, rest8} <- lex_expr__197(rest7),
           {:ok, t9, rest9} <- lex_expr__198(rest8),
           {:ok, t10, rest10} <- lex_expr__199(rest9) do
        {:ok, t0 <> t1 <> t2 <> t3 <> t4 <> t5 <> t6 <> t7 <> t8 <> t9 <> t10, rest10}
      else
        :fail -> :fail
      end
    ...
    def parse_expr__15(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__16(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__18(stream, pos1, ref1, context) do
    ...
    def parse_expr__14(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__15/4, 0, :infinity, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__28(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__29/4, &parse_expr__30/4], stream, pos, ref_stack, context)
    end

    def parse_expr__27(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__28/4, stream, pos, ref_stack, context)
    end

    def parse_expr__26(stream, pos, ref_stack, context) do
      case (&parse_expr__27/4).(stream, pos, ref_stack, context) do
    ...
    def parse_rule__siblings_field(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__31(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__37(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__38(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__40(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
    ...
    def parse_expr__49(stream, pos, ref_stack, context) do
      case (&parse_expr__50/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__45(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__46(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__47(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__49(stream, pos2, ref2, context),
    ...
    def parse_expr__60(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__61(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__64(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__combinator_tail(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__45/4, &parse_expr__55/4, &parse_expr__60/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__71(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__72/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__base_type(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__65/4, &parse_expr__66/4, &parse_expr__67/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__79(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__80/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__call(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__73(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__76(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__77(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__79(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__81(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__83(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__87(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__88/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__order_item_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__84(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__87(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__call_arg(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__103/4, &parse_expr__108/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__121(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__122(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__128(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__129(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__130(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__133(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__134(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__136(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__145(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__146(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__152(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__153(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__154(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__155(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__157(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__158(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__160(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__162(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__163/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__type_kind(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__161(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__162(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__164(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__group_by_rollup(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__165(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__168(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__169(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__171(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__172(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__174(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__182(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__183(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__185(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__181(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__182/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__179(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__180(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__181(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__expression(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__175(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__178(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__189(stream, pos, ref_stack, context) do
      case (&parse_expr__190/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__186(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__192(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__194(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__type_param(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__195(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__198(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__199(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__201(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__when_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__202(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__208(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__209(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__211(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__217(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__218(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__221(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__226(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__227(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__228(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__230(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__222(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__223/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__216(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__217(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__222(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__215(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__216/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__order_by_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__231(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__237(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__fragment_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__245/4, &parse_expr__246/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__predicate_lhs(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__262/4, &parse_expr__263/4, &parse_expr__264/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__with_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__265(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__266(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__268(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__269(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__271(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__272(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__274(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__281(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__282(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__288(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__306(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__307/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__type_expr(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__303(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__306(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__field_name(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__314/4, &parse_expr__315/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__317(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__318/4, &parse_expr__319/4], stream, pos, ref_stack, context)
    end

    def parse_expr__316(stream, pos, ref_stack, context) do
      case (&parse_expr__317/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__type_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__327/4, &parse_expr__328/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__343(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__344/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__select(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__329(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__332(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__333(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__335(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__337(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__339(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__341(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__343(stream, pos8, ref8, context),
           {:ok, pos10, ref10, cap9} <- parse_expr__345(stream, pos9, ref9, context),
           {:ok, pos11, ref11, cap10} <- parse_expr__347(stream, pos10, ref10, context),
           {:ok, pos12, ref12, cap11} <- parse_expr__349(stream, pos11, ref11, context),
           {:ok, pos13, ref13, cap12} <- parse_expr__351(stream, pos12, ref12, context),
           {:ok, pos14, ref14, cap13} <- parse_expr__353(stream, pos13, ref13, context),
           {:ok, pos15, ref15, cap14} <- parse_expr__355(stream, pos14, ref14, context),
           {:ok, pos16, ref16, cap15} <- parse_expr__357(stream, pos15, ref15, context),
           {:ok, pos17, ref17, cap16} <- parse_expr__359(stream, pos16, ref16, context),
           {:ok, pos18, ref18, cap17} <- parse_expr__361(stream, pos17, ref17, context),
           {:ok, pos19, ref19, cap18} <- parse_expr__363(stream, pos18, ref18, context),
           {:ok, pos20, ref20, cap19} <- parse_expr__365(stream, pos19, ref19, context),
           {:ok, pos21, ref21, cap20} <- parse_expr__367(stream, pos20, ref20, context),
           {:ok, pos22, ref22, cap21} <- parse_expr__368(stream, pos21, ref21, context),
           {:ok, pos23, ref23, cap22} <- parse_expr__370(stream, pos22, ref22, context),
           {:ok, pos24, ref24, cap23} <- parse_expr__371(stream, pos23, ref23, context),
           {:ok, pos25, ref25, cap24} <- parse_expr__373(stream, pos24, ref24, context) do
        {:ok, pos25, ref25,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__374(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__375/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__387(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__388/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__385(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__386(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__387(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__397(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__398/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__395(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__396(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__397(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__document(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__374(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__394(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__402(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__404(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__405(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__407(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__body_item(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__413/4, &parse_expr__414/4, &parse_expr__415/4, &parse_expr__416/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__group_by_cube(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__417(stream, pos, ref_stack, context),
           ...
           {:ok, pos6, ref6, cap5} <- parse_expr__424(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__426(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__432(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__433(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__436(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__438(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__439(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__441(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__437(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__438/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__431(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__432(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__437(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__path(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__427(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__430(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__window_call(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__446(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__450(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__452(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__ancestors_field(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__453(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__456(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__457(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__459(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__460(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__462(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__464(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__465/4, &parse_expr__466/4, &parse_expr__467/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__body_item_ep1(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__463/4, &parse_expr__464/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__shape_type(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__468(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__471(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__472(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__474(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__in_lhs(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__496/4, &parse_expr__497/4, &parse_expr__498/4, &parse_expr__499/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__frame_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__500(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__503(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__504(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__506(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__507(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__509(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__510(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__512(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__522(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__523/4, &parse_expr__524/4], stream, pos, ref_stack, context)
    end

    def parse_expr__521(stream, pos, ref_stack, context) do
      case (&parse_expr__522/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__530(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__531/4, &parse_expr__532/4], stream, pos, ref_stack, context)
    end

    def parse_expr__529(stream, pos, ref_stack, context) do
      case (&parse_expr__530/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__frame_bound(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__517/4, &parse_expr__525/4, &parse_expr__533/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__539(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__540/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__negation(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__538(stream, pos, ref_stack, context),
    ...
    def parse_expr__549(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__550(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__551(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__553(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__558(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__559(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__562(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__555(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__556(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__558(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__554(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__555/4, 0, :infinity, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__569(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__570/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__567(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__568(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__569(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__585(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__586(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__588(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__584(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__585/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__578(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__579(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__584(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__rational(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__593(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__599(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__611(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__612(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__614(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__610(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__611/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__604(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__605(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__610(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__603(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__604/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__group_by_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__619(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__623(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__625(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__type_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__655(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__658(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__659(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__661(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__663(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__665(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__666(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__668(stream, pos8, ref8, context),
           {:ok, pos10, ref10, cap9} <- parse_expr__669(stream, pos9, ref9, context),
           {:ok, pos11, ref11, cap10} <- parse_expr__671(stream, pos10, ref10, context) do
        {:ok, pos11, ref11,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__677(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__678(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__681(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__686(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__687(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__690(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__683(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__684(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__686(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__682(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__683/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__676(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__677(stream, pos, ref_stack, context),
    ...
    def parse_expr__675(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__676/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__697(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__698/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__695(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__696(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__697(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__699(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__694(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__695/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__fragment_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__700(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__706(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__707(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__709(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__710(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__712(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__714(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__715/4, &parse_expr__716/4], stream, pos, ref_stack, context)
    end

    def parse_expr__713(stream, pos, ref_stack, context) do
      case (&parse_expr__714/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
          {:ok, new_pos, new_ref_stack, Parser.merge_captures(inner_caps, op: {:text, text})}
    ...
    def parse_rule__additive_tail(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__713(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__719(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__720(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__721(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__727(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__732(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__733/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__field_body_item(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__720/4, &parse_expr__728/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__734(stream, pos, ref_stack, context) do
      case (&parse_expr__735/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__754(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__755/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__parent_field(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__747(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__750(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__751(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__753(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__754(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__756(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__769(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__770(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__771(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__773(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__776(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__777/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__780(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__781/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__778(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__779(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__780(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__782(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__775(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__776(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__778(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__774(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__775/4, 0, :infinity, stream, pos, ref_stack, context)
    end
