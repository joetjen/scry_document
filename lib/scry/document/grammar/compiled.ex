...
defmodule Scry.Document.Grammar.Compiled do
  @moduledoc false
  (
    ...
    def lex_expr__7(input) do
      Tokenizer.first_char_match([&lex_expr__8/1, &lex_expr__9/1], input)
    end
    ...
    def lex_token__ESCAPED_IDENT(input0) do
      with {:ok, t0, rest0} <- lex_expr__6(input0),
           ...
           {:ok, t2, rest2} <- lex_expr__10(rest1),
           {:ok, t3, rest3} <- lex_expr__14(rest2) do
        {:ok, t0 <> t1 <> t2 <> t3, rest3}
      else
        :fail -> :fail
      end
    ...
    def lex_token__KW_SIBLINGS(input0) do
      with {:ok, t0, rest0} <- lex_expr__15(input0),
           ...
           {:ok, t4, rest4} <- lex_expr__19(rest3),
           {:ok, t5, rest5} <- lex_expr__20(rest4),
           {:ok, t6, rest6} <- lex_expr__21(rest5),
           {:ok, t7, rest7} <- lex_expr__22(rest6) do
    ...
    def lex_expr__23(input) do
      Tokenizer.plus_char(&lex_expr__24/1, input)
    end
    ...
    def lex_expr__25(input) do
      Tokenizer.opt_char(&lex_expr__26/1, input)
    end
    ...
    def lex_token__KW_PARENT(input0) do
      with {:ok, t0, rest0} <- lex_expr__44(input0),
           ...
           {:ok, t3, rest3} <- lex_expr__47(rest2),
           {:ok, t4, rest4} <- lex_expr__48(rest3),
           {:ok, t5, rest5} <- lex_expr__49(rest4) do
    ...
    def lex_expr__60(input0) do
      with {:ok, t0, rest0} <- lex_expr__61(input0), {:ok, t1, rest1} <- lex_expr__62(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_token__DURATION(input0) do
      with {:ok, t0, rest0} <- lex_expr__57(input0),
           {:ok, t1, rest1} <- lex_expr__59(rest0),
    ...
    def lex_expr__80(input) do
      Tokenizer.not_pred_char(&lex_expr__81/1, input)
    end
    ...
    def lex_expr__79(input0) do
      with {:ok, t0, rest0} <- lex_expr__80(input0), {:ok, t1, rest1} <- lex_expr__85(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__77(input) do
      Tokenizer.first_char_match([&lex_expr__78/1, &lex_expr__79/1], input)
    end

    def lex_expr__76(input) do
      Tokenizer.star_char(&lex_expr__77/1, input)
    end
    ...
    def lex_expr__86(input0) do
      with {:ok, t0, rest0} <- lex_expr__87(input0),
           ...
           {:ok, t2, rest2} <- lex_expr__89(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__115(input) do
      Tokenizer.plus_char(&lex_expr__116/1, input)
    end
    ...
    def lex_expr__112(input) do
      Tokenizer.opt_char(&lex_expr__113/1, input)
    end
    ...
    def lex_expr__120(input0) do
      with {:ok, t0, rest0} <- lex_expr__121(input0),
           ...
           {:ok, t5, rest5} <- lex_expr__126(rest4) do
        {:ok, t0 <> t1 <> t2 <> t3 <> t4 <> t5, rest5}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__117(input) do
      Tokenizer.opt_char(&lex_expr__118/1, input)
    end

    def lex_expr__102(input0) do
      with {:ok, t0, rest0} <- lex_expr__103(input0),
           {:ok, t1, rest1} <- lex_expr__104(rest0),
           {:ok, t2, rest2} <- lex_expr__105(rest1),
           {:ok, t3, rest3} <- lex_expr__106(rest2),
           {:ok, t4, rest4} <- lex_expr__107(rest3),
           {:ok, t5, rest5} <- lex_expr__108(rest4),
           {:ok, t6, rest6} <- lex_expr__109(rest5),
           {:ok, t7, rest7} <- lex_expr__110(rest6),
           {:ok, t8, rest8} <- lex_expr__111(rest7),
           {:ok, t9, rest9} <- lex_expr__112(rest8),
           {:ok, t10, rest10} <- lex_expr__117(rest9) do
    ...
    def lex_expr__101(input) do
      Tokenizer.opt_char(&lex_expr__102/1, input)
    end

    def lex_token__DATE(input0) do
      with {:ok, t0, rest0} <- lex_expr__91(input0),
           {:ok, t1, rest1} <- lex_expr__92(rest0),
           {:ok, t2, rest2} <- lex_expr__93(rest1),
           {:ok, t3, rest3} <- lex_expr__94(rest2),
           {:ok, t4, rest4} <- lex_expr__95(rest3),
           {:ok, t5, rest5} <- lex_expr__96(rest4),
           {:ok, t6, rest6} <- lex_expr__97(rest5),
           {:ok, t7, rest7} <- lex_expr__98(rest6),
           {:ok, t8, rest8} <- lex_expr__99(rest7),
           {:ok, t9, rest9} <- lex_expr__100(rest8),
           {:ok, t10, rest10} <- lex_expr__101(rest9) do
        {:ok, t0 <> t1 <> t2 <> t3 <> t4 <> t5 <> t6 <> t7 <> t8 <> t9 <> t10, rest10}
      else
        :fail -> :fail
      end
    ...
    def lex_token__KW_ANCESTORS(input0) do
      with {:ok, t0, rest0} <- lex_expr__127(input0),
           ...
           {:ok, t8, rest8} <- lex_expr__135(rest7) do
    ...
    def lex_expr__143(input0) do
      with {:ok, t0, rest0} <- lex_expr__144(input0),
           ...
           {:ok, t4, rest4} <- lex_expr__148(rest3) do
    ...
    def lex_token__ESCAPE(input0) do
      with {:ok, t0, rest0} <- lex_expr__136(input0), {:ok, t1, rest1} <- lex_expr__137(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__154(input0) do
      with {:ok, t0, rest0} <- lex_expr__155(input0), {:ok, t1, rest1} <- lex_expr__157(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_token__COMMENT(input0) do
      with {:ok, t0, rest0} <- lex_expr__152(input0), {:ok, t1, rest1} <- lex_expr__153(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_token__NOT_EQ(input0) do
      with {:ok, t0, rest0} <- lex_expr__161(input0),
           ...
           {:ok, t2, rest2} <- lex_expr__163(rest1),
           {:ok, t3, rest3} <- lex_expr__164(rest2) do
        {:ok, t0 <> t1 <> t2 <> t3, rest3}
      else
        :fail -> :fail
      end
    ...
    def lex_token__POW(input0) do
      with {:ok, t0, rest0} <- lex_expr__165(input0), {:ok, t1, rest1} <- lex_expr__166(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_token__GE(input0) do
      with {:ok, t0, rest0} <- lex_expr__167(input0), {:ok, t1, rest1} <- lex_expr__168(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__181(input) do
      Tokenizer.star_char(&lex_expr__182/1, input)
    end
    ...
    def lex_expr__191(input) do
      Tokenizer.not_pred_char(&lex_expr__192/1, input)
    end
    ...
    def lex_expr__190(input0) do
      with {:ok, t0, rest0} <- lex_expr__191(input0), {:ok, t1, rest1} <- lex_expr__193(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__187(input) do
      Tokenizer.star_char(&lex_expr__188/1, input)
    end
    ...
    def lex_expr__201(input) do
      Tokenizer.not_pred_char(&lex_expr__202/1, input)
    end
    ...
    def lex_expr__200(input0) do
      with {:ok, t0, rest0} <- lex_expr__201(input0), {:ok, t1, rest1} <- lex_expr__203(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__197(input) do
      Tokenizer.star_char(&lex_expr__198/1, input)
    end
    ...
    def lex_expr__195(input0) do
      with {:ok, t0, rest0} <- lex_expr__196(input0),
           ...
           {:ok, t2, rest2} <- lex_expr__204(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_token__STRING(input) do
      Tokenizer.first_char_match([&lex_expr__185/1, &lex_expr__195/1], input)
    end
    ...
    def lex_expr__208(input) do
      Tokenizer.plus_char(&lex_expr__209/1, input)
    end

    def lex_expr__205(input0) do
      with {:ok, t0, rest0} <- lex_expr__206(input0),
           {:ok, t1, rest1} <- lex_expr__207(rest0),
           {:ok, t2, rest2} <- lex_expr__208(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__213(input) do
      Tokenizer.plus_char(&lex_expr__214/1, input)
    end

    def lex_expr__210(input0) do
      with {:ok, t0, rest0} <- lex_expr__211(input0),
           {:ok, t1, rest1} <- lex_expr__212(rest0),
           {:ok, t2, rest2} <- lex_expr__213(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__218(input) do
      Tokenizer.plus_char(&lex_expr__219/1, input)
    end

    def lex_expr__215(input0) do
      with {:ok, t0, rest0} <- lex_expr__216(input0),
           {:ok, t1, rest1} <- lex_expr__217(rest0),
           {:ok, t2, rest2} <- lex_expr__218(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_token__RADIX(input) do
      Tokenizer.first_char_match([&lex_expr__205/1, &lex_expr__210/1, &lex_expr__215/1], input)
    end
    ...
    def lex_expr__220(input) do
      Tokenizer.plus_char(&lex_expr__221/1, input)
    end
    ...
    def lex_expr__223(input) do
      Tokenizer.plus_char(&lex_expr__224/1, input)
    end

    def lex_token__DECIMAL(input0) do
      with {:ok, t0, rest0} <- lex_expr__220(input0),
           {:ok, t1, rest1} <- lex_expr__222(rest0),
           {:ok, t2, rest2} <- lex_expr__223(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def parse_rule__superset_of_op(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__11(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__14(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__22(stream, pos, ref_stack, context) do
      case (&parse_expr__23/4).(stream, pos, ref_stack, context) do
    ...
    def parse_rule__bitwise_lhs(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__38(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__44(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__56(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__57/4, stream, pos, ref_stack, context)
    end

    def parse_expr__55(stream, pos, ref_stack, context) do
      case (&parse_expr__56/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__with_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__52(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__58(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__60(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__61(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__63(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__64(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__66(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__list_type(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__67(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__73(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__union_tail(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__74(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__77(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__qualified_call_with_path(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__89(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__92(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__93(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__95(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__parent_field(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__96(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__100(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__102(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__103(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__105(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__if_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__106(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__109(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__select_ep1a(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__110/4, &parse_expr__111/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__fragment_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__112/4, &parse_expr__113/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__type_param(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__126(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__132(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__136(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__137(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__139(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__135(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__136/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__133(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__134(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__135(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__subset_or_eq_op(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__146(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__149(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__150(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__152(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__153(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__155(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__order_by_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__163(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__166(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__167(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__169(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__with_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__170/4, &parse_expr__171/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__175(stream, pos, ref_stack, context) do
      case (&parse_expr__176/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__172(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__178(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__180(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__190(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__191/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__188(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__189(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__190(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__mult_lhs(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__181(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__184(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__185(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__187(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__206(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__207(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__209(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__205(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__206/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__199(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__200(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__205(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__superset_or_eq_op(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__214(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__220(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__221(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__223(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__229(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__230/4, &parse_expr__231/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__227(stream, pos, ref_stack, context) do
      case (&parse_expr__228/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__240(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__241(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__245(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__247(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__287(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__288/4, stream, pos, ref_stack, context)
    end

    def parse_expr__286(stream, pos, ref_stack, context) do
      case (&parse_expr__287/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__body_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__282(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__286(stream, pos3, ref3, context) do
        {:ok, pos4, ref4,
         Parser.merge_captures(
           cap0,
    ...
    def parse_expr__300(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__301(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__303(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__299(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__300/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__293(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__294(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__299(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__292(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__293/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__field_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__289(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__290(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__292(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__type_field(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__308(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__309(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__311(stream, pos2, ref2, context),
    ...
    def parse_rule__group_by_cube(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__332(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__336(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__338(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__339(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__341(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__qualified_call(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__346(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__349(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__350(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__352(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__353(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__355(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__356(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__358(stream, pos8, ref8, context),
           {:ok, pos10, ref10, cap9} <- parse_expr__360(stream, pos9, ref9, context),
           {:ok, pos11, ref11, cap10} <- parse_expr__362(stream, pos10, ref10, context) do
        {:ok, pos11, ref11,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__frame_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__367(stream, pos, ref_stack, context),
           ...
           {:ok, pos8, ref8, cap7} <- parse_expr__377(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__379(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__382(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__383/4, &parse_expr__384/4], stream, pos, ref_stack, context)
    end

    def parse_expr__381(stream, pos, ref_stack, context) do
      case (&parse_expr__382/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__380(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__381(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__385(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__387(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__unary(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__380/4, &parse_expr__388/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__391(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__392(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__395(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__base_type(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__389/4, &parse_expr__390/4, &parse_expr__391/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__411(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__412(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__414(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__410(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__411/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__408(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__409(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__410(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__421(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__422(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__424(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__420(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__421/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__418(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__419(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__420(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__document(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__397(stream, pos, ref_stack, context),
           ...
           {:ok, pos8, ref8, cap7} <- parse_expr__428(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__430(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__452(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__453/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__454(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__455/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__458(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__459/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__466(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__467/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__select(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__432(stream, pos, ref_stack, context),
           ...
           {:ok, pos6, ref6, cap5} <- parse_expr__440(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__442(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__444(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__446(stream, pos8, ref8, context),
           {:ok, pos10, ref10, cap9} <- parse_expr__448(stream, pos9, ref9, context),
           {:ok, pos11, ref11, cap10} <- parse_expr__450(stream, pos10, ref10, context),
           {:ok, pos12, ref12, cap11} <- parse_expr__452(stream, pos11, ref11, context),
           {:ok, pos13, ref13, cap12} <- parse_expr__454(stream, pos12, ref12, context),
           {:ok, pos14, ref14, cap13} <- parse_expr__456(stream, pos13, ref13, context),
           {:ok, pos15, ref15, cap14} <- parse_expr__458(stream, pos14, ref14, context),
           {:ok, pos16, ref16, cap15} <- parse_expr__460(stream, pos15, ref15, context),
           {:ok, pos17, ref17, cap16} <- parse_expr__462(stream, pos16, ref16, context),
           {:ok, pos18, ref18, cap17} <- parse_expr__464(stream, pos17, ref17, context),
           {:ok, pos19, ref19, cap18} <- parse_expr__466(stream, pos18, ref18, context),
           {:ok, pos20, ref20, cap19} <- parse_expr__468(stream, pos19, ref19, context),
           {:ok, pos21, ref21, cap20} <- parse_expr__470(stream, pos20, ref20, context),
           {:ok, pos22, ref22, cap21} <- parse_expr__472(stream, pos21, ref21, context),
           {:ok, pos23, ref23, cap22} <- parse_expr__474(stream, pos22, ref22, context),
           {:ok, pos24, ref24, cap23} <- parse_expr__475(stream, pos23, ref23, context),
           {:ok, pos25, ref25, cap24} <- parse_expr__477(stream, pos24, ref24, context),
           {:ok, pos26, ref26, cap25} <- parse_expr__478(stream, pos25, ref25, context),
           {:ok, pos27, ref27, cap26} <- parse_expr__480(stream, pos26, ref26, context) do
        {:ok, pos27, ref27,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__type_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__481(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__487(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__489(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__491(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__492(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__494(stream, pos8, ref8, context),
           {:ok, pos10, ref10, cap9} <- parse_expr__495(stream, pos9, ref9, context),
           {:ok, pos11, ref11, cap10} <- parse_expr__497(stream, pos10, ref10, context) do
        {:ok, pos11, ref11,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__ancestors_field(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__498(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__501(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__502(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__504(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__505(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__507(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__511(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__512/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__type_field_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__508(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__511(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__541(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__542(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__543(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__545(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__537(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__538/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__531(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__532(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__537(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__530(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__531/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__553(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__554(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__556(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__552(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__553/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__550(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__551(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__552(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__568(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__569(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__571(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__567(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__568/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__561(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__562(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__567(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__582(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__583/4, &parse_expr__584/4, &parse_expr__585/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__type_operand(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__586(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__589(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__591(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__group_by_rollup(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__592(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__593(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__595(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__596(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__598(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__599(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__601(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__mult_tail(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__602(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__606(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__608(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__614(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__615/4, &parse_expr__616/4], stream, pos, ref_stack, context)
    end

    def parse_expr__613(stream, pos, ref_stack, context) do
      case (&parse_expr__614/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__622(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__623/4, &parse_expr__624/4], stream, pos, ref_stack, context)
    end

    def parse_expr__621(stream, pos, ref_stack, context) do
      case (&parse_expr__622/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__627(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__628/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__625(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__626(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__629(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__frame_bound(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__609/4, &parse_expr__617/4, &parse_expr__625/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__rational(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__630(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__631(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__633(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__634(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__636(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__644(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__645(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__647(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__643(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__644/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__641(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__642(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__643(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__body_item(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__648/4, &parse_expr__649/4, &parse_expr__650/4, &parse_expr__651/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__666(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__667(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__670(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__662(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__663/4, 0, :infinity, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__655(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__656/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__call_with_path(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__671(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__674(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__675(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__677(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__679(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__680/4, &parse_expr__681/4], stream, pos, ref_stack, context)
    end

    def parse_expr__678(stream, pos, ref_stack, context) do
      case (&parse_expr__679/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
          {:ok, new_pos, new_ref_stack, Parser.merge_captures(inner_caps, op: {:text, text})}
    ...
    def parse_rule__fragment_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__695(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__701(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__702(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__704(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__705(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__707(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__siblings_field(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__708(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__714(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__715(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__717(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__729(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__730/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__over_spec(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__729(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__733(stream, pos2, ref2, context),
    ...
    def parse_rule__shape_type(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__759(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__763(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__765(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__771(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__772/4, stream, pos, ref_stack, context)
    end

    def parse_expr__770(stream, pos, ref_stack, context) do
      case (&parse_expr__771/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__773(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__774/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__766(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__767(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__768(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__770(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__773(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__775(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__781(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__782(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__785(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__combinator_tail(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__766/4, &parse_expr__776/4, &parse_expr__781/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__type_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__786/4, &parse_expr__787/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__795(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__796(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__798(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__794(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__795/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__792(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__793(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__794(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__791(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__792/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__combined_select(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__788(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__791(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__field_name(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__799/4, &parse_expr__800/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__801(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__802(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__806(stream, pos3, ref3, context) do
        {:ok, pos4, ref4,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(cap1, Parser.merge_captures(cap2, cap3))
    ...
    def parse_rule__body_list_tail(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__801/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__808(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__809/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__812(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__813(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__816(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__818(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__819(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__821(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__817(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__818/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__811(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__812(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__817(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__810(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__811/4, stream, pos, ref_stack, context)
    end

    def parse_rule__call_args(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__807(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__808(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__810(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__826(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__827(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__830(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__831(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__833(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__834(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__835(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__838(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__839(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__841(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__856(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__855(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__856/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__850(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__851(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__852(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__854(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__855(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__857(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__861(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__860(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__861/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__858(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__859(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__860(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__862(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__863(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__865(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__867(stream, pos, ref_stack, context) do
      case parse_rule__in_lhs(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, sub_captures} ->
          {:ok, new_pos, new_ref_stack, left: {:rule, :in_lhs, sub_captures}}
    ...
    def parse_expr__871(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__872/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__866(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__867(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__870(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__871(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__873(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__878(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__879/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__880(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__881/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__goal_args(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__875(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__876(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__878(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__880(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__882(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__888(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__889/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__892(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__891(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__892/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__893(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__894/4, stream, pos, ref_stack, context)
    end

    def parse_expr__883(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__884(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__885(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__887(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__888(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__890(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__891(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__893(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__896(stream, pos, ref_stack, context) do
      case parse_rule__path(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, sub_captures} ->
    ...
    def parse_expr__898(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__897(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__898/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__899(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__900/4, stream, pos, ref_stack, context)
    end

    def parse_expr__895(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__896(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__897(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__899(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__field_body_item(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__883/4, &parse_expr__895/4], stream, pos, ref_stack, context)
    end

    def parse_expr__901(stream, pos, ref_stack, context) do
      case parse_rule__multiplicative(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, sub_captures} ->
          {:ok, new_pos, new_ref_stack, left: {:rule, :multiplicative, sub_captures}}
    ...
    def parse_expr__904(stream, pos, ref_stack, context) do
      case parse_rule__additive_tail(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, sub_captures} ->
    ...
    def parse_expr__909(stream, pos, ref_stack, context) do
      case parse_rule__additive_tail(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, sub_captures} ->
    ...
    def parse_expr__913(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__912(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__913/4, stream, pos, ref_stack, context)
    end

    def parse_expr__914(stream, pos, ref_stack, context) do
      case parse_rule__additive_tail(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, sub_captures} ->
          {:ok, new_pos, new_ref_stack, rest: {:rule, :additive_tail, sub_captures}}
    ...
    def parse_expr__911(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__912(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__914(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__910(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__911/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__908(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__909(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__910(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__916(stream, pos, ref_stack, _context) do
    ...
    def parse_expr__918(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__917(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__918/4, stream, pos, ref_stack, context)
    end

    def parse_expr__919(stream, pos, ref_stack, context) do
      case parse_rule__expression(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, sub_captures} ->
          {:ok, new_pos, new_ref_stack, expr: {:rule, :expression, sub_captures}}
    ...
    def parse_expr__915(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__916(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__917(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__919(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__920(stream, pos, ref_stack, context) do
      case parse_rule__expression(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, sub_captures} ->
    ...
    def parse_rule__call_arg(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__915/4, &parse_expr__920/4], stream, pos, ref_stack, context)
    end

    def parse_expr__923(stream, pos, ref_stack, _context) do
    ...
    def parse_expr__924(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :PIPE) do
        {:ok, new_pos, text, nil} -> {:ok, new_pos, ref_stack, PIPE: {:token, :PIPE, text}}
        {:ok, new_pos, _text, capture} -> {:ok, new_pos, ref_stack, PIPE: capture}
        :fail -> :fail
    ...
    def parse_expr__922(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__923/4, &parse_expr__924/4], stream, pos, ref_stack, context)
    end

    def parse_expr__921(stream, pos, ref_stack, context) do
      case (&parse_expr__922/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
          {:ok, new_pos, new_ref_stack, Parser.merge_captures(inner_caps, op: {:text, text})}
    ...
    def parse_expr__926(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__925(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__926/4, stream, pos, ref_stack, context)
    end

    def parse_expr__927(stream, pos, ref_stack, context) do
      case parse_rule__additive(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, sub_captures} ->
    ...
    def parse_rule__bitwise_tail(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__921(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__925(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__927(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__928(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :KW_SUBSET) do
        {:ok, new_pos, text, nil} -> {:ok, new_pos, ref_stack, marker: {:token, :KW_SUBSET, text}}
        {:ok, new_pos, _text, capture} -> {:ok, new_pos, ref_stack, marker: capture}
        :fail -> :fail
    ...
    def parse_expr__930(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :TRIVIA) do
        {:ok, new_pos, _text, _capture} -> {:ok, new_pos, ref_stack, []}
        :fail -> :fail
      end
    ...
    def parse_expr__929(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__930/4, stream, pos, ref_stack, context)
    end

    def parse_expr__931(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :KW_OF) do
        {:ok, new_pos, text, nil} -> {:ok, new_pos, ref_stack, KW_OF: {:token, :KW_OF, text}}
        {:ok, new_pos, _text, capture} -> {:ok, new_pos, ref_stack, KW_OF: capture}
        :fail -> :fail
    ...
    def parse_rule__subset_of_op(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__928(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__929(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__931(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__932(stream, pos, ref_stack, _context) do
      case Parser.match_token(stream, pos, :NEVER) do
        {:ok, new_pos, text, nil} -> {:ok, new_pos, ref_stack, NEVER: {:token, :NEVER, text}}
        {:ok, new_pos, _text, capture} -> {:ok, new_pos, ref_stack, NEVER: capture}
        :fail -> :fail
    ...
    def parse_expr__934(stream, pos, ref_stack, context) do
    ...
    def parse_expr__935(stream, pos, ref_stack, context) do
    ...
    def parse_expr__936(stream, pos, ref_stack, context) do
    ...
    def parse_expr__933(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__934/4, &parse_expr__935/4, &parse_expr__936/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__body_item_ep1(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__932/4, &parse_expr__933/4], stream, pos, ref_stack, context)
    end
           ...
           {:ok, value, _context} <-
             Ichor.Actions.evaluate(
               ...
               %{
                 ...
                 document: MapSet.new([:with_or_comment, :type_or_comment, :fragment_or_comment]),
                 select: MapSet.new([]),
      ...
      if pos >= tuple_size(stream) do
        ...
        case parse_rule__document(stream, pos, [0], ctx) do
          {:ok, new_pos, _ref_stack, raw_captures} ->
            case Ichor.Actions.evaluate(:document, raw_captures, Scry.Document.Actions, ctx, %{
                   additive: MapSet.new([:additive_tail]),
                   superset_of_op: MapSet.new([]),
                   partition_clause: MapSet.new([]),
                   negation: MapSet.new([]),
                   ...
                   base_type: MapSet.new([]),
                   document:
                     MapSet.new([:with_or_comment, :type_or_comment, :fragment_or_comment]),
                   select: MapSet.new([]),
                   type_decl: MapSet.new([]),
                   ancestors_field: MapSet.new([]),
                   type_field_list: MapSet.new([:tail, :COMMA]),
